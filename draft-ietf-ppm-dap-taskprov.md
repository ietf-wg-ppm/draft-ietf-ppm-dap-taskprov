...
upload request to the Leader (as described in {{Section 4.4 of !DAP}}), it
...
is the `TaskConfiguration` structure defined in {{Section 4.2 of !DAP}},
...
task ID derived from the `TaskConfiguration` as defined in {{definition}}.
